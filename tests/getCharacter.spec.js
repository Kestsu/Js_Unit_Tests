...
describe("9 - Implemente os casos de teste da função `getCharacter`", () => {
  it("Verifica se a função `getCharacter` retorna o objeto do personagem corretamente./ Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.", () => {
...
expect(getCharacter('Melissandre') === getCharacter('MELISSANDRE')).toBe(true)
  });
  it("Teste se ao passar um nome que não está na tabela, a função retorna undefined.", () => {
    // Teste se ao passar um nome que não está na tabela, a função retorna undefined.
    expect(getCharacter('kevin')).toBeUndefined()
  });
});
